...
import { normalizeCandidateProfileForPresentation } from '../services/candidateProfileSanitizer.js';
...
export function serializeOrganisationPost(post) {
  if (!post) return null;
  return {
    id: post.id,
...
export function serializeCandidateProfile(profile, options = {}) {
  ...
  return {
    ...
    phoneNumber: includePrivate ? safeProfile.phoneNumber : undefined,
    headline: safeProfile.headline,
    currentTitle: safeProfile.currentTitle,
    currentEmployer: includePrivate ? safeProfile.currentEmployer : undefined,
    currentDesignation: includePrivate ? safeProfile.currentDesignation : undefined,
    location: safeProfile.location,
    preferredLocations: safeProfile.preferredLocations,
    preferredRoles: safeProfile.preferredRoles,
    totalExperience: safeProfile.totalExperience,
    workplacePreferences: safeProfile.workplacePreferences,
    employmentPreferences: safeProfile.employmentPreferences,
    availability: safeProfile.availability,
    employmentStatus: includePrivate ? safeProfile.employmentStatus : undefined,
    lastWorkingDate: includePrivate ? iso(safeProfile.lastWorkingDate) : undefined,
    willingToRelocate: includePrivate ? safeProfile.willingToRelocate : undefined,
    noticePeriodDays: includePrivate ? safeProfile.noticePeriodDays : undefined,
    skills: safeProfile.skills,
    skillEntries: includePrivate ? safeProfile.skillEntries || [] : undefined,
    experienceEntries: includePrivate ? safeProfile.experienceEntries || [] : undefined,
    educationEntries: includePrivate ? safeProfile.educationEntries || [] : undefined,
    certificationEntries: includePrivate ? safeProfile.certificationEntries || [] : undefined,
    languageEntries: includePrivate ? safeProfile.languageEntries || [] : undefined,
    projectEntries: includePrivate ? safeProfile.projectEntries || [] : undefined,
    portfolioLinks: includePrivate ? safeProfile.portfolioLinks || [] : undefined,
    summary: safeProfile.summary,
    profileImageUrl: safeProfile.profileImageUrl,
    portfolioUrl: safeProfile.portfolioUrl,
    linkedInUrl: safeProfile.linkedInUrl,
    githubUrl: safeProfile.githubUrl,
    email: includePrivate ? safeProfile.email : undefined,
    profileStatus: includePrivate ? safeProfile.profileStatus : undefined,
    source: includePrivate ? safeProfile.source : undefined,
    profileVisibility: includePrivate ? safeProfile.profileVisibility : undefined,
    recommendationEnabled: includePrivate ? safeProfile.recommendationEnabled : undefined,
    notifyForSavedJobUpdates: includePrivate ? safeProfile.notifyForSavedJobUpdates : undefined,
    notifyForApplicationUpdates: includePrivate ? safeProfile.notifyForApplicationUpdates : undefined,
    notifyForRecommendations: includePrivate ? safeProfile.notifyForRecommendations : undefined,
    notifyForInterviews: includePrivate ? safeProfile.notifyForInterviews : undefined,
    notifyForOffers: includePrivate ? safeProfile.notifyForOffers : undefined,
    notifyForProfileReminders: includePrivate ? safeProfile.notifyForProfileReminders : undefined,
    notifyForMarketing: includePrivate ? safeProfile.notifyForMarketing : undefined,
    currentCtcLpa: includePrivate ? safeProfile.currentCtcLpa : undefined,
    expectedCtcLpa: includePrivate ? safeProfile.expectedCtcLpa : undefined,
    minExpectedSalary: includePrivate ? safeProfile.minExpectedSalary : undefined,
    preferredCurrency: includePrivate ? safeProfile.preferredCurrency : undefined,
    workAuthorization: includePrivate ? safeProfile.workAuthorization : undefined,
    requiresVisaSponsorship: includePrivate ? safeProfile.requiresVisaSponsorship : undefined,
    preferredIndustries: includePrivate ? safeProfile.preferredIndustries : undefined,
    preferredCompanySizes: includePrivate ? safeProfile.preferredCompanySizes : undefined,
    travelWillingness: includePrivate ? safeProfile.travelWillingness : undefined,
    jobAlertEnabled: includePrivate ? safeProfile.jobAlertEnabled : undefined,
    jobAlertFrequency: includePrivate ? safeProfile.jobAlertFrequency : undefined,
    searchableProfile: includePrivate ? safeProfile.searchableProfile : undefined,
    phoneVisibleToRecruiters: includePrivate ? safeProfile.phoneVisibleToRecruiters : undefined,
    salaryVisibleToRecruiters: includePrivate ? safeProfile.salaryVisibleToRecruiters : undefined,
    resumeVisibleToRecruiters: includePrivate ? safeProfile.resumeVisibleToRecruiters : undefined,
    notificationPreferences: includePrivate ? safeProfile.notificationPreferences : undefined,
    accountLifecycleStatus: includePrivate ? safeProfile.accountLifecycleStatus : undefined,
    accountDeactivationRequestedAt: includePrivate ? iso(safeProfile.accountDeactivationRequestedAt) : undefined,
    onboardingStep: includePrivate ? safeProfile.onboardingStep : undefined,
    onboardingCompletedAt: includePrivate ? iso(safeProfile.onboardingCompletedAt) : undefined,
    onboardingSkippedResume: includePrivate ? safeProfile.onboardingSkippedResume : undefined,
    resumeUrl: includePrivate ? resumeDownloadUrl(safeProfile) : undefined,
    sharedResumeSlug: safeProfile.sharedResumeSlug,
    profileViews: includePrivate ? safeProfile.profileViews : undefined,
    lastActiveAt: iso(safeProfile.lastActiveAt),
    updatedAt: iso(safeProfile.updatedAt),
  };
}
...
export function serializeJob(job, options = {}) {
  ...
  return {
    ...
    activatedAt: iso(job.activatedAt),
    activeUntil: iso(job.activeUntil),
    autoClosedAt: iso(job.autoClosedAt),
...
export function serializeApplication(application, options = {}) {
  ...
  return {
    ...
    // Candidate-facing callers (e.g. the candidate dashboard) must pass
    // publicJob so a hidden salary never leaks through the embedded job -
    // recruiter/ATS callers keep the full internal job serialization.
    job: options.publicJob
      ? serializePublicJob(application.job)
      : serializeJob(application.job, { publicRecruiter: true, includeRequisition: true }),
