...
resumeRouter.post('/search/v2', auth(['RECRUITER', 'ADMIN']), requireResumeDatabaseAccess(), requireVerifiedOrganisation(), validateSchema(resumeSearchV2RequestSchema), searchResumeDatabaseV2);
