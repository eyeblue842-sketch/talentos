...
export default function CompanyError({ reset }) {
  return (
    <main className="mx-auto min-h-screen max-w-3xl px-6 py-16 text-center lg:px-10">
      <div role="alert" className="rounded-[28px] border border-rose-200 bg-white p-8 shadow-[0_18px_48px_rgba(16,36,24,0.07)]">
        <h1 className="font-[var(--font-display)] text-3xl font-semibold">Unable to load this careers page</h1>
        <p className="mt-3 text-sm leading-7 text-[var(--muted)]">The company careers information is temporarily unavailable.</p>
