  ...
  return (
    <main className="mx-auto grid min-h-screen max-w-7xl gap-6 px-6 py-8 lg:grid-cols-[280px_1fr] lg:px-10">
      ...
      <section className="space-y-6">
        <div>
          <p className="text-sm uppercase tracking-[0.24em] text-[var(--brand)]">Hiring workspace</p>
          <h1 className="mt-2 font-[var(--font-display)] text-4xl font-semibold">Operations command center</h1>
          <p className="mt-2 text-[var(--muted)]">Manage roles, candidate flow, and hiring execution inside the standalone CareerCraft AI platform.</p>
        </div>
